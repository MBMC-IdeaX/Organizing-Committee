              ...
              GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Welcome to the IdeaX Hackathon Administration Portal. Phase 1 foundation is active.',
              ...
              GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppDimensions.space8),
                    _buildStatusRow('Role-Based Authorization', 'ADMIN VERIFIED', BadgeType.info),
                    const SizedBox(height: AppDimensions.space8),
                    _buildStatusRow('Admin Dashboard UI', 'PHASE 2 (Upcoming)', BadgeType.neutral),
                  ],
                ),
              ),
